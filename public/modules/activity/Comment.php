...
class Comment {
    ...
    function getDeleteCommentForm($id) {
        ...
        $view = new View();
        $view->setTmpl(file('views/activity/delete_comment_form.php'), array(
    ...
    function getAllCommentsView($activity_id) {
        $view = new View();
        $view->setTmpl(file('views/activity/list_all_comments.php'));
    ...
    function getNewCommentForm($id) {
        ...
        $view = new View();
        $view->setTmpl(file('views/activity/new_comment_form.php'), array(
