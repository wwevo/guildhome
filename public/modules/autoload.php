...
require_once "gw2api/Gw2Api_Interface.php";
    ...
    require_once "gw2api/accounts/guilds/Gw2Api_Guilds.php";
        require_once "gw2api/accounts/guilds/roster/Gw2Api_Roster_Model.php";
        require_once "gw2api/accounts/guilds/roster/Gw2Api_Roster_View.php";
        require_once "gw2api/accounts/guilds/roster/Gw2Api_Roster.php";
        require_once "gw2api/accounts/guilds/roster/members/Gw2Api_Members_Model.php";
        require_once "gw2api/accounts/guilds/roster/members/Gw2Api_Members_View.php";
        require_once "gw2api/accounts/guilds/roster/members/Gw2Api_Members.php";
