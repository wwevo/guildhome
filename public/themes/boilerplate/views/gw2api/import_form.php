...
<h3>Import data</h3>
<p>Please only use the import function as sparsely as possible. It is still in early development and may cause heavy use of the gw2 api.</p>
...
<section class="settings form">
    <form method="post" action="{##form_action##}" onsubmit="event.preventDefault(); makerequest(this)">
        <input type="submit" id="submit" name="gw2api_import[submit]" value="{##gw2api_import_submit_text##}" /><span id="status">({##import_status##})</span>
    </form>
</section>
