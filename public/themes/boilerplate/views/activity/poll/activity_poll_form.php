<section class="form">
    <form method="post" action="{##form_action##}">
        <fieldset>
            ...
            Date: <input type="date" name="activity[date]" placeholder="Date" value="{##activity_date##}" />{##activity_date_validation##}
            Time: <input type="time" name="activity[time]" placeholder="Time" value="{##activity_time##}" />{##activity_time_validation##}<br />
